...
if (!inFrame && !navigator.userAgent.includes('Firefox')) {
  ...
  if (!popup || popup.closed) {
    ...
    const icon = localStorage.getItem('icon') || 'https://app.schoology.com/sites/all/themes/schoology_theme/favicon.ico'
    ...
    const pLink = localStorage.getItem(encodeURI('pLink')) || 'https://dvsd.schoology.com/'
